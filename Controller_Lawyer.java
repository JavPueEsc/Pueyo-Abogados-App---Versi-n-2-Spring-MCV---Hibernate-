...
public class Controller_Lawyer {
	...
	@PostMapping
	public String insertLawyer(@Valid @ModelAttribute("lawyer") Lawyer lawyer, BindingResult resultadoValidacion, Model model) {
	...
	public String updateLawyer(@Valid @ModelAttribute("lawyer")Lawyer lawyer, BindingResult resultadoValidacion, Model model) {
		if(resultadoValidacion.hasErrors()) {
			model.addAttribute("modo","update");
			return "Lawyers-form";
		}
